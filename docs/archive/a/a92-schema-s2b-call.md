...
(`docs/archive/sketches/notify/notify.can`) is green on the S2a check
...
Parent: `docs/archive/a/a91-schema-s2-design.md` (S2b gate);
consumers 2–3: `docs/archive/sketches/reserve/`, `docs/archive/sketches/notify/`.
