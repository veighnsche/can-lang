...
only live content, joined by the former `std/html/HISTORY.md` below.
Current dispositions are summarized in
...
- `html.can` — `mod html`: `brand Html__Text`, `html__text__escape`
  ...
  `docs/archive/a/encoder-nul-policy.md`.
- `html__text__node` promotes `Html__Text` to the second brand,
  ...
  `docs/archive/a/a26-html-node.md`.
- `html__attribute__name` gates `Html__TextAttributeName`: a small
  ...
  See `docs/archive/a/a27-attribute-name.md`.
- `html__attribute__text` composes a brand-typed name with an
  ...
  `docs/archive/a/a29-attribute-value.md`.
- `html__attribute__boolean_name` gates
  ...
  `docs/archive/a/a30-boolean-attribute.md`.
- `html__attribute__id` validates an identifier (nonempty, no
  ...
  `docs/archive/a/a31-identifier-attribute.md`.
- `html__attribute__href` / `html__attribute__src` validate
  ...
  `html.disallowed_scheme`. See `docs/archive/a/a32-url-attributes.md`.
- `html__fragment__empty` seals `""` as the zero `Html__Safe`
  fragment. See `docs/archive/a/a33-empty-fragment.md`.
- `html__fragment__join`/`_from` walk explicit `Html__Children`
  ...
  preserved exactly. See `docs/archive/a/a42-fragment-join.md`.
- `Html__NamedAttribute` pairs a minted attribute with its name
  ...
  forwarded unchanged). See `docs/archive/a/a43-named-attributes.md`.
- `html__asset__stylesheet` is the first pinned bridge sink (S2 slice
  ...
  flow. See `std/schema/README.md`, `docs/archive/a/a83-astra-schema.md`.
...
Rules: `/REQUIREMENTS.md`. Program: `docs/archive/a/a25-html-text.md`,
`docs/archive/a/a26-html-node.md`, `docs/archive/a/a27-attribute-name.md`,
`docs/archive/a/a29-attribute-value.md`, `docs/archive/a/a30-boolean-attribute.md`,
`docs/archive/a/a31-identifier-attribute.md`, `docs/archive/a/a32-url-attributes.md`,
`docs/archive/a/a33-empty-fragment.md`, `docs/archive/a/a34-boolean-names.md`,
`docs/archive/a/encoder-nul-policy.md`, brand scope: `docs/archive/a/a15-brands.md`.
