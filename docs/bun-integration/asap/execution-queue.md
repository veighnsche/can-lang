...
- [ ] **B1-01.06** — Add owned streaming readers/writers once B1-05 settles the lifecycle; bounded operations can ship earlier. Test short writes, failure cleanup and release of locks/handles. (Pending on B1-05; file-stream wiring completes under B1-05.08. Bounded B1-01 ships without it.)
