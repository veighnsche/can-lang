...
This ledger maps approved contracts to **planned**, not completed, work. Every task remains unchecked in [tasks](tasks.md). C/Q/A/P refer to the linked current specs there. A task's absence from the first runnable milestone does not defer it from the final initial distribution.
