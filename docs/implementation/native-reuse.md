...
| HTMX/static assets | Exact upstream HTMX2.0.10; Bun.file; SHA hashing | P11 static policy, digest checks, closed asset types, reserved route, no eval/scripts, 422swap | No client Can runtime or new browser framework; I34 |
