...
The review read every current decision section and the complete capability catalogue, as recorded in the rule map. It cross-checked selected historical native-AI proposals at their actual current paths: [a95 native syntax alternatives](/Users/vince/Projects/can-lang/docs/a95-jev-native-syntax-options.md:1), [a94 judgment evidence](/Users/vince/Projects/can-lang/docs/a94-jev-judgment-evidence-decision.md:1), [a96 implementation plan](/Users/vince/Projects/can-lang/docs/a96-jev-implementation-plan.md:1), and [a97 integration ideas](/Users/vince/Projects/can-lang/docs/a97-jev-integration-ideas.md:1). Those files were used selectively; they do not reapprove old uncertainty bands, exact-decimal probabilities, effects, revision/pinning machinery, scripts, or rejected syntax. The old a95 statement that a94 was unavailable describes an earlier snapshot, not the current filesystem.
