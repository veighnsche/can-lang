...
| E01 | in progress (wave 1) | lane-e-e01-e03 (`9`) | isolated | none | C-C→F01/F05/C; hooks→E02/E04/E06 | — | — |
...
| C01 | ready (H01 done) | — | — | H01 | runners→C02/C06/H13 | — | — |
| H02 | ready (H01 done) | — | — | H01 | DB access→E02/F02/F04/F06 | — | — |
| H03 | ready (H01 done) | — | — | H01 | storage→E07/E09 | — | — |
| H04 | ready (H01 done) | — | — | H01 | AI gate→H08 | — | — |
| H05 | ready (H01 done) | — | — | H01 | x86→H12 | — | — |
