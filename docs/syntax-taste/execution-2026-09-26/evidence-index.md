...
| C01 | open (blocked provision) | wiring `c37c40fc`+`a3c4a11f` pending in retained worktree, NOT on main | macOS 27, Playwright 1.55.1 | native Firefox impossible on macOS 27 (FF141 GFX/sandbox hang; FF155 vendor-dir kernel-denied incl root); container path validated: pinned arm64 playwright:v1.55.1-noble launchServer, FF141 connect + page load OK from macOS; Chromium/WebKit native OK | blocked |
