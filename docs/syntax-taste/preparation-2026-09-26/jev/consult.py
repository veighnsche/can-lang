"""Send the already prepared preparation-round requests; credentials stay in the environment."""
import json
import os
import time
...
for number in range(1, 4):
    ...
    (here / f"jev-response-{number}.json").write_text(json.dumps(result, indent=2) + "\n")
