...
export function createPath(){
 return Object.freeze({
  async resolvePath(base:string,parts:readonly string[],_context?:AssertionContext):Promise<Completion<string>>{
   return success(resolve(base,...parts));
  },
  async joinPath(parts:readonly string[],_context?:AssertionContext):Promise<Completion<string>>{
