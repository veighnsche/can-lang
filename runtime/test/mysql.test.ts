...
const drop = (table: string): SQLDescriptorEntry => ({
  ...
  segments: [{ text: `DROP TABLE IF EXISTS ${table}` }], params: [], paramType: "p", rowType: "r", limit: 0, total: 0, version: V,
});
const table: Record<string, Record<string, SQLDescriptorEntry>> = {
  "": {
    drop_cover: drop("cover"), drop_uq: drop("uq"), drop_my: drop("mycover"), drop_misc: drop("misc"), drop_ts: drop("tscover"), drop_seq: drop("seq"),
    setup_cover: {
    ...
    cover_all: {
      ...
      segments: [{ text: "SELECT id, flag, ratio, name, payload, note FROM cover LIMIT " }, { param: 1 }],
    ...
    delete_cover: {
      ...
      params: ["id"], paramType: "p", rowType: "r", limit: 0, total: 1, version: V,
    },
    setup_uq: {
      dialect: D, cardinality: "execute", kind: "create_table_statement",
      segments: [{ text: "CREATE TABLE uq (id INT PRIMARY KEY, v VARCHAR(32) UNIQUE)" }], params: [], paramType: "p", rowType: "r", limit: 0, total: 0, version: V,
    },
    insert_uq: {
      dialect: D, cardinality: "execute", kind: "insert_statement",
      segments: [{ text: "INSERT INTO uq VALUES (" }, { param: 1 }, { text: ", " }, { param: 2 }, { text: ")" }],
      params: ["id", "v"], paramType: "p", rowType: "r", limit: 0, total: 2, version: V,
    },
    setup_my: {
      dialect: D, cardinality: "execute", kind: "create_table_statement",
      segments: [{ text: "CREATE TABLE mycover (id BIGINT PRIMARY KEY, amount DECIMAL(30,10), stamp DATETIME(3), ubig BIGINT UNSIGNED, bit1 BIT(1), bit4 BIT(4))" }], params: [], paramType: "p", rowType: "r", limit: 0, total: 0, version: V,
    },
    insert_my: {
      dialect: D, cardinality: "execute", kind: "insert_statement",
      segments: [{ text: "INSERT INTO mycover VALUES (" }, { param: 1 }, { text: ", " }, { param: 2 }, { text: ", " }, { param: 3 }, { text: ", " }, { param: 4 }, { text: ", " }, { param: 5 }, { text: ", " }, { param: 6 }, { text: ")" }],
      params: ["id", "amount", "stamp", "ubig", "bit1", "bit4"], paramType: "p", rowType: "r", limit: 0, total: 6, version: V,
    },
    my_by_id: {
      dialect: D, cardinality: "one", kind: "select_statement",
      segments: [{ text: "SELECT id, amount, stamp, ubig, bit1, bit4 FROM mycover WHERE id = " }, { param: 1 }, { text: " LIMIT " }, { param: 2 }],
      params: ["id"], paramType: "p", rowType: "r", limit: 2, total: 2, version: V,
    },
    setup_misc: {
      dialect: D, cardinality: "execute", kind: "create_table_statement",
      segments: [{ text: "CREATE TABLE misc (id INT PRIMARY KEY, j JSON, ti TIME, y YEAR, e ENUM('a','b'), s SET('x','y'))" }], params: [], paramType: "p", rowType: "r", limit: 0, total: 0, version: V,
    },
    insert_misc: {
      dialect: D, cardinality: "execute", kind: "insert_statement",
      segments: [{ text: "INSERT INTO misc VALUES (" }, { param: 1 }, { text: ", " }, { param: 2 }, { text: ", " }, { param: 3 }, { text: ", " }, { param: 4 }, { text: ", " }, { param: 5 }, { text: ", " }, { param: 6 }, { text: ")" }],
      params: ["id", "j", "ti", "y", "e", "s"], paramType: "p", rowType: "r", limit: 0, total: 6, version: V,
    },
    misc_by_id: {
      dialect: D, cardinality: "one", kind: "select_statement",
      segments: [{ text: "SELECT id, j, ti, y, e, s FROM misc WHERE id = " }, { param: 1 }, { text: " LIMIT " }, { param: 2 }],
      params: ["id"], paramType: "p", rowType: "r", limit: 2, total: 2, version: V,
    },
    setup_ts: {
      dialect: D, cardinality: "execute", kind: "create_table_statement",
      segments: [{ text: "CREATE TABLE tscover (id INT PRIMARY KEY, ts TIMESTAMP(3))" }], params: [], paramType: "p", rowType: "r", limit: 0, total: 0, version: V,
    },
    insert_ts: {
      dialect: D, cardinality: "execute", kind: "insert_statement",
      segments: [{ text: "INSERT INTO tscover VALUES (" }, { param: 1 }, { text: ", " }, { param: 2 }, { text: ")" }],
      params: ["id", "ts"], paramType: "p", rowType: "r", limit: 0, total: 2, version: V,
    },
    misc_text_by_id: {
      dialect: D, cardinality: "one", kind: "select_statement",
      segments: [{ text: "SELECT ti, y, e, s FROM misc WHERE id = " }, { param: 1 }, { text: " LIMIT " }, { param: 2 }],
      params: ["id"], paramType: "p", rowType: "r", limit: 2, total: 2, version: V,
    },
    ts_by_id: {
      dialect: D, cardinality: "one", kind: "select_statement",
      segments: [{ text: "SELECT id, ts FROM tscover WHERE id = " }, { param: 1 }, { text: " LIMIT " }, { param: 2 }],
      params: ["id"], paramType: "p", rowType: "r", limit: 2, total: 2, version: V,
    },
    setup_seq: {
      dialect: D, cardinality: "execute", kind: "create_table_statement",
      segments: [{ text: "CREATE TABLE seq (id BIGINT AUTO_INCREMENT PRIMARY KEY)" }], params: [], paramType: "p", rowType: "r", limit: 0, total: 0, version: V,
    },
    insert_seq: {
      dialect: D, cardinality: "execute", kind: "insert_statement",
      segments: [{ text: "INSERT INTO seq VALUES ()" }], params: [], paramType: "p", rowType: "r", limit: 0, total: 0, version: V,
    },
    last_id: {
      dialect: D, cardinality: "one", kind: "select_statement",
    ...
    broken_syntax: {
      dialect: D, cardinality: "execute", kind: "insert_statement",
      segments: [{ text: "INSERT INTO cover VALUES (" }], params: [], paramType: "p", rowType: "r", limit: 0, total: 0, version: V,
    },
    drop_absent: {
      dialect: D, cardinality: "execute", kind: "delete_statement",
      segments: [{ text: "DELETE FROM absent" }], params: [], paramType: "p", rowType: "r", limit: 0, total: 0, version: V,
    },
    bad_column: {
      dialect: D, cardinality: "one", kind: "select_statement",
      segments: [{ text: "SELECT nope FROM cover WHERE id = " }, { param: 1 }, { text: " LIMIT " }, { param: 2 }],
      params: ["id"], paramType: "p", rowType: "r", limit: 2, total: 2, version: V,
    },
    pg_by_id: {
      dialect: "postgresql", cardinality: "one", kind: "SelectStmt",
      segments: [{ text: "SELECT id FROM cover WHERE id = " }, { param: 1 }, { text: " LIMIT " }, { param: 2 }],
...
const deleteParams: SQLPlan = { params: { root: "app::cover_delete", fields: [{ name: "id", kind: "int" }] } };
...
const miscTextParams: SQLPlan = {
  params: { root: "app::misc_parameters", fields: [{ name: "id", kind: "int" }] },
  rows: { root: "app::misc_text_row", fields: [{ name: "ti", kind: "str" }, { name: "y", kind: "int" }, { name: "e", kind: "str" }, { name: "s", kind: "str" }] },
};
const tsInsertParams: SQLPlan = { params: { root: "app::ts_insert", fields: [{ name: "id", kind: "int" }, { name: "ts", kind: "str" }] } };
const tsParams: SQLPlan = {
  params: { root: "app::ts_parameters", fields: [{ name: "id", kind: "int" }] },
  rows: { root: "app::ts_row", fields: [{ name: "id", kind: "int" }, { name: "ts", kind: "str" }] },
};
const uqInsertParams: SQLPlan = { params: { root: "app::uq_insert", fields: [{ name: "id", kind: "int" }, { name: "v", kind: "str" }] } };
const idParams: SQLPlan = {
  params: { root: "app::id_parameters", fields: [{ name: "id", kind: "int" }] },
  rows: { root: "app::id_row", fields: [{ name: "id", kind: "int" }] },
};
const lastIdParams: SQLPlan = { params: { root: "app::empty", fields: [] }, rows: { root: "app::id_row", fields: [{ name: "id", kind: "int" }] } };
...
describe("mysql pools", () => {
  live("open validates credentials, config, and the UTC pin", async () => {
    await owned(async () => {
      ...
      expect(domainOutcome(await pools.mysqlOpen("bad-name", 2n), "http::credentials_missing")).toEqual({ variable: "bad-name" });
      expect(domainOutcome(await pools.mysqlOpen("CAN_TEST_ABSENT", 2n), "http::credentials_missing")).toEqual({ variable: "CAN_TEST_ABSENT" });
      expect(domainOutcome(await pools.mysqlOpen("CAN_TEST_MYSQL", 0n), "sql::connection_failed")).toEqual({ phase: "config" });
      expect(domainOutcome(await pools.mysqlOpen("CAN_TEST_MYSQL_REFUSED", 2n), "sql::connection_failed")).toEqual({ phase: "connect" });
      expect(domainOutcome(await pools.mysqlOpen("CAN_TEST_MYSQL_BADPASSWORD", 2n), "sql::connection_failed")).toEqual({ phase: "connect" });
      expect(domainOutcome(await pools.mysqlOpen("CAN_TEST_MYSQL_NODB", 2n), "sql::connection_failed")).toEqual({ phase: "connect" });
    });
  });
  live("pools round-trip the shared cover exactly", async () => {
    await owned(async () => {
      ...
      const rows: Array<[bigint, boolean, number, string, Uint8Array, unknown]> = [
        [9007199254740993n, true, 1.5, "n1", new Uint8Array([1]), record("app::option_some", [["value", "s1"]])],
        [MIN_INT64, false, 0, "n2-ünïcødé-🎉", new Uint8Array(0), record("app::option_none", [])],
        [MAX_INT64, true, -2.5, "n3", new Uint8Array([9, 9, 9]), record("app::option_some", [["value", "s3"]])],
      ];
      for (const [idn, flag, ratio, name, bytes, note] of rows) {
        expect(value(await pools.execute(insert, insertParams, token,
          record("app::cover_insert", [["id", idn], ["flag", flag], ["ratio", ratio], ["name", name], ["payload", ownBytes(bytes)], ["note", note]])))).toBe(1n);
      }
      for (const [idn, flag, ratio, name, bytes, note] of rows) {
        ...
        if (recordIdentity(note) === "app::option_some") expect(dataProperty(dataProperty(row, "note"), "value")).toBe(dataProperty(note, "value"));
      }
      value(await pools.close(token, 1000n));
    });
  });
  live("execute reports exact affected counts including zero", async () => {
    await owned(async () => {
      ...
      const mk = (idn: bigint) => record("app::cover_insert", [["id", idn], ["flag", false], ["ratio", 0], ["name", "n"], ["payload", ownBytes(new Uint8Array(0))], ["note", record("app::option_none", [])]]);
      ...
      expect(value(await pools.execute(update, flagParams, token, record("app::flag_update", [["flag", true], ["id", 1n]])))).toBe(1n);
      expect(value(await pools.execute(remove, deleteParams, token, record("app::cover_delete", [["id", 2n]])))).toBe(1n);
      expect(value(await pools.execute(remove, deleteParams, token, record("app::cover_delete", [["id", 2n]])))).toBe(0n);
      value(await pools.close(token, 1000n));
    });
  });
  live("mysql-native types map exactly", async () => {
    await owned(async () => {
      const token = value(await pools.mysqlOpen("CAN_TEST_MYSQL", 2n));
      for (const name of ["drop_my", "drop_misc", "drop_ts"]) value(await pools.execute(descriptors.declareDescriptor("", name), emptyParams, token, record("app::empty", [])));
      for (const name of ["setup_my", "setup_misc", "setup_ts"]) value(await pools.execute(descriptors.declareDescriptor("", name), emptyParams, token, record("app::empty", [])));
      expect(value(await pools.execute(descriptors.declareDescriptor("", "insert_my"), myInsertParams, token,
        record("app::my_insert", [["id", 1n], ["amount", "12345678901234567890.1234567890"], ["stamp", "2026-03-04 05:06:07.890"], ["ubig", "5"], ["bit1", true], ["bit4", ownBytes(new Uint8Array([10]))]])))).toBe(1n);
      const row = value(await pools.queryOne(descriptors.declareDescriptor("", "my_by_id"), myParams, token, record("app::my_parameters", [["id", 1n]])));
      ...
      expect(value(await pools.execute(descriptors.declareDescriptor("", "insert_misc"), miscInsertParams, token,
        record("app::misc_insert", [["id", 1n], ["j", "{\"k\":[1,2]}"], ["ti", "11:22:33"], ["y", 2026n], ["e", "b"], ["s", "x,y"]])))).toBe(1n);
      ...
      expect(value(await pools.execute(descriptors.declareDescriptor("", "insert_ts"), tsInsertParams, token,
        record("app::ts_insert", [["id", 1n], ["ts", "2026-01-15 12:00:00.123"]])))).toBe(1n);
      const ts = value(await pools.queryOne(descriptors.declareDescriptor("", "ts_by_id"), tsParams, token, record("app::ts_parameters", [["id", 1n]])));
      expect(dataProperty(ts, "ts")).toBe("2026-01-15 12:00:00.123");
      const ti = value(await pools.queryOne(descriptors.declareDescriptor("", "misc_text_by_id"), miscTextParams, token, record("app::misc_parameters", [["id", 1n]])));
  ...
  live("unsigned overflow and JSON objects reject without coercion", async () => {
    await owned(async () => {
      const token = value(await pools.mysqlOpen("CAN_TEST_MYSQL", 2n));
      for (const name of ["drop_my", "drop_misc"]) value(await pools.execute(descriptors.declareDescriptor("", name), emptyParams, token, record("app::empty", [])));
      for (const name of ["setup_my", "setup_misc"]) value(await pools.execute(descriptors.declareDescriptor("", name), emptyParams, token, record("app::empty", [])));
      expect(value(await pools.execute(descriptors.declareDescriptor("", "insert_my"), myInsertParams, token,
        record("app::my_insert", [["id", 2n], ["amount", "1.5"], ["stamp", "2026-01-01 00:00:00"], ["ubig", "18446744073709551615"], ["bit1", false], ["bit4", ownBytes(new Uint8Array([1]))]])))).toBe(1n);
      expect(domainOutcome(await pools.queryOne(descriptors.declareDescriptor("", "my_by_id"), myParams, token, record("app::my_parameters", [["id", 2n]])), "sql::schema_mismatch")).toEqual({ path: "/ubig", reason: "int_range" });
      expect(value(await pools.execute(descriptors.declareDescriptor("", "insert_misc"), miscInsertParams, token,
        record("app::misc_insert", [["id", 2n], ["j", "{\"k\":1}"], ["ti", "00:00:01"], ["y", 2000n], ["e", "a"], ["s", "x"]])))).toBe(1n);
      expect(domainOutcome(await pools.queryOne(descriptors.declareDescriptor("", "misc_by_id"), miscParams, token, record("app::misc_parameters", [["id", 2n]])), "sql::schema_mismatch")).toEqual({ path: "/j", reason: "type" });
      // Malformed decimal text is server-rejected under strict mode;
      // the adapter never parses it, so nothing coerces.
      expect(domainOutcome(await pools.execute(descriptors.declareDescriptor("", "insert_my"), myInsertParams, token,
        record("app::my_insert", [["id", 3n], ["amount", "banana"], ["stamp", "2026-01-01 00:00:00"], ["ubig", "1"], ["bit1", false], ["bit4", ownBytes(new Uint8Array([1]))]])), "sql::query_failed")).toEqual({ operation: "execute", code: "mysql_errno_1366" });
      value(await pools.close(token, 1000n));
    });
  });
  live("dialect mismatch fails before any native call", async () => {
    await owned(async () => {
      ...
      expect(domainOutcome(await pools.queryOne(pg, idParams, token, record("app::id_parameters", [["id", 1n]])), "sql::query_failed")).toEqual({ operation: "query_one", code: "dialect_mismatch" });
      value(await pools.close(token, 1000n));
    });
  });
  live("failures classify with verified codes", async () => {
    await owned(async () => {
      const token = value(await pools.mysqlOpen("CAN_TEST_MYSQL", 2n));
      value(await pools.execute(descriptors.declareDescriptor("", "drop_uq"), emptyParams, token, record("app::empty", [])));
      value(await pools.execute(descriptors.declareDescriptor("", "setup_uq"), emptyParams, token, record("app::empty", [])));
      const insert = descriptors.declareDescriptor("", "insert_uq");
      expect(value(await pools.execute(insert, uqInsertParams, token, record("app::uq_insert", [["id", 1n], ["v", "a"]])))).toBe(1n);
      expect(domainOutcome(await pools.execute(insert, uqInsertParams, token, record("app::uq_insert", [["id", 2n], ["v", "a"]])), "sql::constraint_failed")).toEqual({ constraint: "ER_DUP_ENTRY" });
      expect(domainOutcome(await pools.execute(descriptors.declareDescriptor("", "broken_syntax"), emptyParams, token, record("app::empty", [])), "sql::query_failed")).toEqual({ operation: "execute", code: "ER_PARSE_ERROR" });
      expect(domainOutcome(await pools.execute(descriptors.declareDescriptor("", "drop_absent"), emptyParams, token, record("app::empty", [])), "sql::query_failed")).toEqual({ operation: "execute", code: "ER_NO_SUCH_TABLE" });
      value(await pools.execute(descriptors.declareDescriptor("", "drop_cover"), emptyParams, token, record("app::empty", [])));
      value(await pools.execute(descriptors.declareDescriptor("", "setup_cover"), emptyParams, token, record("app::empty", [])));
      expect(domainOutcome(await pools.queryOne(descriptors.declareDescriptor("", "bad_column"), coverParams, token, record("app::cover_parameters", [["id", 1n]])), "sql::query_failed")).toEqual({ operation: "query_one", code: "mysql_errno_1054" });
      value(await pools.close(token, 1000n));
    });
  });
  live("hostile text travels only as a bound parameter", async () => {
    await owned(async () => {
      ...
      value(await pools.execute(descriptors.declareDescriptor("", "setup_cover"), emptyParams, token, record("app::empty", [])));
      const evil = "x' OR '1'='1' -- /*";
      expect(value(await pools.execute(descriptors.declareDescriptor("", "insert_cover"), insertParams, token,
        record("app::cover_insert", [["id", 77n], ["flag", true], ["ratio", 0], ["name", evil], ["payload", ownBytes(new Uint8Array(0))], ["note", record("app::option_none", [])]])))).toBe(1n);
      const row = value(await pools.queryOne(descriptors.declareDescriptor("", "cover_by_id"), coverParams, token, record("app::cover_parameters", [["id", 77n]])));
      expect(dataProperty(row, "name")).toBe(evil);
      const rows = value(await pools.queryRows(descriptors.declareDescriptor("", "cover_all"), coverRows, token, record("app::empty", []), 10n));
  ...
  live("descriptors reuse native prepares across executions", async () => {
    await owned(async () => {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        expect(value(await pools.execute(insert, insertParams, token,
          record("app::cover_insert", [["id", idn], ["flag", i % 2 === 0], ["ratio", i], ["name", `r${i}`], ["payload", ownBytes(new Uint8Array([i]))], ["note", record("app::option_none", [])]])))).toBe(1n);
        const row = value(await pools.queryOne(byId, coverParams, token, record("app::cover_parameters", [["id", idn]])));
  ...
  live("generated ids read back through LAST_INSERT_ID", async () => {
    await owned(async () => {
      const token = value(await pools.mysqlOpen("CAN_TEST_MYSQL", 2n));
      value(await pools.execute(descriptors.declareDescriptor("", "drop_seq"), emptyParams, token, record("app::empty", [])));
      value(await pools.execute(descriptors.declareDescriptor("", "setup_seq"), emptyParams, token, record("app::empty", [])));
      expect(value(await pools.execute(descriptors.declareDescriptor("", "insert_seq"), emptyParams, token, record("app::empty", [])))).toBe(1n);
      expect(value(await pools.execute(descriptors.declareDescriptor("", "insert_seq"), emptyParams, token, record("app::empty", [])))).toBe(1n);
      const row = value(await pools.queryOne(descriptors.declareDescriptor("", "last_id"), lastIdParams, token, record("app::empty", [])));
