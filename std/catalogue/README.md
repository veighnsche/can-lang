...
| s3::upload_write | s3::upload upload, bytes::buffer chunk → int | [s3::upload_closed, s3::access_denied, s3::service_error] |  | NetworkSink | Append one chunk to an open upload and report accepted bytes; use after finish or discard fails upload_closed. | supplied | B1-10 / B1-10,E08 |
